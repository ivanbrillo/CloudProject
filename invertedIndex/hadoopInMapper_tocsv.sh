    ...
    for REDUCERS in "${NUMBER_REDUCERS[@]}"; do
        ...
        for (( RUN_ID=1; RUN_ID<=TIMES; RUN_ID++ )); do
            ...
            for SIZE in "${SIZES[@]}"; do
                ...
                OUTPUT_DIR="outputInMapper_${DATASET_SIZE}/${OUTPUT_BASE_INDEX}_${SIZE}"
...

                {
                    ...
                    echo "hadoopInMapperCombiner,$SIZE,$DATASET_SIZE,$SPLIT,$REDUCERS,$DIFF_MS,$MEMORY,$TS"
                } >> hadoopInMapperCombiner.csv
